...
schema_csv = StructType([
    ...
    StructField("cd_rubrica", StringType(), True),  # String previne perda de formatação se houver zeros à esquerda
...
if arg == 'setup':
    if not DeltaTable.isDeltaTable(spark, path_refined):
        ...
        df_vazio.write \
            .format("delta") \
            .save(path_refined)
        print("Tabela Delta 'dim_rubrica_receita' inicializada com sucesso na camada Refined.")
    else:
    ...
    try:
        ...
        print("Processamento de atualização da dim_rubrica_receita concluído com sucesso!")
